package com.example.perkapp.sync
...
import com.example.perkapp.network.MediaApiService
import com.example.perkapp.repository.MediaRepository
...
class SyncWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val userPrefs = com.example.perkapp.database.UserPreferences(applicationContext.dataStore)
        ...
        val kegiatanApi = retrofit.create(com.example.perkapp.network.KegiatanApiService::class.java)
        val kegiatanDao = database.kegiatanDao()
        val kegiatanRepository = com.example.perkapp.repository.KegiatanRepositoryImpl(kegiatanApi, kegiatanDao, applicationContext)
